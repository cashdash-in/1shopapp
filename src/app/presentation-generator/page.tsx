...
export default function PresentationGeneratorPage() {
    ...
    const downloadPptxOutline = () => {
        ...
        content += `Generated by 1ShopApp AI Assistant\n`;
        content += `==========================================\n\n`;
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = `${topic.toLowerCase().replace(/\s+/g, '-')}-outline.txt`;
        a.click();
        URL.revokeObjectURL(url);
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                         ...
                         <div className="space-y-2">
                            <Label htmlFor="instructions">Structural Instructions (Optional)</Label>
                            <Textarea
                                id="instructions"
                                value={instructions}
                            ...
                            {result.slides.map((slide, index) => (
                                <Card key={index} className="bg-secondary/50 border-primary/5">
                                    <CardHeader className="flex flex-row items-start justify-between">
                                        <div>
                                            <p className="text-xs font-bold text-primary tracking-widest uppercase mb-1">SLIDE {index + 1}</p>
                    ...
                    <div className="space-y-6 pt-6 border-t">
                        <h2 className="text-2xl font-bold text-center">Efficiency Shortcuts</h2>
